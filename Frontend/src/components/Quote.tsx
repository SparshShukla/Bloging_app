export const Quote = () => {
  return (
    <div className="bg-slate-200 h-screen flex justify-center flex-col bg-teal-900 ">
      <div className="flex justify-center">
        <div className="max-w-lg text-slate-200 antialiased">
          <div className="text-3xl font-bold text-pretty">
            ...
            about or to add value on, but if you’re good at something and you’ve
            had success at something, just think more about that—and write
            everything out.”
          </div>
